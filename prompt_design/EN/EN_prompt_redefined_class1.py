...
1, INAPPROPRIATE, if the comment has no target but contains terms that are obscene, vulgar, curse words, or swear words, but not violent nor offensive. Explicitly use this if someone is just swearing out of frustration without attacking a person.
...
# --- Output file ---
OUTPUT_FILE = f"EN_prompt_redefined_class1.csv"
