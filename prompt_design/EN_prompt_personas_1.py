...
# Persona 1: Simulates a highly literal, strict annotator
SYSTEM_PROMPT_1 = "You are a literal content moderation classifier. Look for clear, explicit violations of the scale definitions below." + SCALE_DEFINITIONS

# Persona 2: Simulates a sensitive, context-aware annotator
SYSTEM_PROMPT_2 = "You are a sociolinguistic annotator. Pay close attention to underlying context, implicit bias, and covert slurs based on the scale definitions below." + SCALE_DEFINITIONS
...
# --- Output file ---
OUTPUT_FILE = f"EN_prompt_persona_rotation.csv"
